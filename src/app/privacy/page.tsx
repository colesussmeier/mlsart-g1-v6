...
const Privacy = () => {
    return (
        <div className="flex flex-col items-center min-h-[100vh]">
            <div className="max-w-[85vw] pt-8 flex flex-col items-center space-y-5">
            <h1 className="font-bold">Privacy Policy</h1>
            <h2>Effective Date: 4/12/24</h2>

            <p>This Privacy Policy describes the ways we collect, store, use, and protect your personal information when you use our website located at www.marylousussmeier.com. By using our website you consent to the terms of this Privacy Policy.</p>
            ...
            <ul>
                ...
                <li><strong>Order Information:</strong> When you purchase a painting, we collect your name, shipping address, billing address, email address, phone number, and payment information.</li>
            ...
            <p>We take appropriate measures to protect your information from unauthorized access, use, or disclosure. However, no data transmission over the internet is 100% secure.</p> 

            <h2 className="font-bold">Cookies</h2>
            <p>Our website uses only necessary cookies. These are small files placed on your device that are essential for the basic functionality of our website, such as enabling navigation or facilitating the checkout process. We do not use cookies for tracking or advertising purposes.</p>
            ...
            <p>We may update this Privacy Policy. Any changes will be reflected by the "Effective Date" above. Your continued use of the website after changes are made indicates your acceptance of the revised Privacy Policy.</p> 

            <h2 className="font-bold">Contact Us</h2>
            <p className="pb-10">If you have questions about this Privacy Policy, please contact us at: msussmeierart@gmail.com.</p> 
        </div>
        </div>
    );
};
